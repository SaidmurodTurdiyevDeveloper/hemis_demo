...
import '../../../presenter/main_tab/lesson_schedule/lesson_schedule_tab.dart';
...
/// -------------------------
///  Demo / default schedule
/// -------------------------
List<StudentScheduleData> generateDefaultSchedule(DateTime now,) {
  final monday = now.subtract(Duration(days: now.weekday - DateTime.monday));

  final List<StudentScheduleData> list = [];

  // Ichki helper: bitta darsni qo‘shish
  void addLesson({
    required int dayOffset, // 0 = Dushanba, 1 = Seshanba, ...
    ...
    final lessonId = list.length + 1;

    list.add(
      StudentScheduleData(
        id: lessonId,
        status: _randomStatus(Random()),
        lessonDate: date.millisecondsSinceEpoch ~/ 1000,
        weekStartTime: monday.millisecondsSinceEpoch ~/ 1000,
        weekEndTime: monday
            .add(const Duration(days: 6, hours: 23, minutes: 59))
            .millisecondsSinceEpoch ~/
            1000,
        iWeek: 1,
        faculty: StudentScheduleFaculty(
          id: 1,
          name: 'Fizika',
          structureType: StudentScheduleStructureType(
            name: 'Maruza',
            code: 'F',
          )
        ),
        subject: StudentScheduleSubject(
          id: lessonId,
          code: 'SUB$lessonId',
          name: subjectName,
        ),
        employee: StudentScheduleEmployee(
          id: lessonId,
          name: teacherName,
        ),
        lessonPair: StudentScheduleLessonPair(
          code: 'P$pairIndex',
          name: 'Pair $pairIndex',
          startTime: start,
          endTime: end,
        ),
        group: StudentScheduleGroup(
          id: 1,
          name: '221‑Group',
        ),
      ),
  ...
  // Dushanba
  addLesson(dayOffset: 0,
      start: '08:30',
      end: '10:00',
      subjectName: 'Matematika',
      teacherName: 'Islomov I.I',
      pairIndex: 1);
  addLesson(dayOffset: 0,
      start: '10:10',
      end: '11:40',
      subjectName: 'Fizika',
      teacherName: 'Karimov K.K',
      pairIndex: 2);

  addLesson(dayOffset: 1,
      start: '11:30',
      end: '13:00',
      subjectName: 'Tarix',
      teacherName: 'Tursunova T.T',
      pairIndex: 1);
...
LessonStatus _randomStatus(Random rnd) =>
    LessonStatus.values[rnd.nextInt(LessonStatus.values.length)];
